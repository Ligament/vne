...
export type ProductVariant = {
  ...
  vending_machine_slot_link?: Maybe<LinkVendingMachineModuleVendingMachineSlotProductProductVariant>;
  vending_machine_slot?: Maybe<VendingMachineSlot>;
};
...
export type Order = {
  ...
  vending_machine_order_link?: Maybe<LinkVendingMachineModuleVendingMachineOrderOrderOrder>;
  vending_machine_order?: Maybe<VendingMachineOrder>;
};
...
export type DigitalProductMedia = {
  ...
  digitalProduct: Array<Maybe<DigitalProduct>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
};
...
export type VendingMachine = {
  ...
  status: Scalars['String']['output'];
  slots: Array<Maybe<VendingMachineSlot>>;
  orders: Array<Maybe<VendingMachineOrder>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
};

export enum VendingMachineSlotStateEnum {
  Empty = 'EMPTY',
  Occupied = 'OCCUPIED',
  Reserved = 'RESERVED'
}
...
export type VendingMachineSlot = {
  __typename?: 'VendingMachineSlot';
  id: Scalars['ID']['output'];
  slotNumber: Scalars['Int']['output'];
  state: VendingMachineSlotStateEnum;
  vendingMachine: Array<Maybe<VendingMachine>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  product_variant_link?: Maybe<LinkVendingMachineModuleVendingMachineSlotProductProductVariant>;
  product_variant?: Maybe<ProductVariant>;
};

export enum VendingMachineOrderStatusEnum {
  Pending = 'PENDING',
  Fulfilled = 'FULFILLED',
  Cancelled = 'CANCELLED',
  Done = 'DONE'
...
export type VendingMachineOrder = {
  __typename?: 'VendingMachineOrder';
  id: Scalars['ID']['output'];
  status: VendingMachineOrderStatusEnum;
  products: Array<Maybe<VendingMachine>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  order_link?: Maybe<LinkVendingMachineModuleVendingMachineOrderOrderOrder>;
  order?: Maybe<Order>;
};
...
export type LinkVendingMachineModuleVendingMachineOrderOrderOrder = {
  __typename?: 'LinkVendingMachineModuleVendingMachineOrderOrderOrder';
  vending_machine_order_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  order?: Maybe<Order>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkVendingMachineModuleVendingMachineSlotProductProductVariant = {
  __typename?: 'LinkVendingMachineModuleVendingMachineSlotProductProductVariant';
  vending_machine_slot_id: Scalars['String']['output'];
  product_variant_id: Scalars['String']['output'];
  product_variant?: Maybe<Product>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    vending_machine_slots: VendingMachineSlot
    vending_machine_order: VendingMachineOrder
    vending_machine_orders: VendingMachineOrder
    ...
    vending_machine_order_order: LinkVendingMachineModuleVendingMachineOrderOrderOrder
    vending_machine_slot_product_variant: LinkVendingMachineModuleVendingMachineSlotProductProductVariant
  }
}